use utf8;
package Jefit::Classic::Result::WorkOutExerciseList;
...
Jefit::Classic::Result::WorkOutExerciseList
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:C7XTxvnWLXYrdWGasfMqmg
